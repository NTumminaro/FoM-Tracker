				...
				>
					<IconButton
						sx={{
							height: 40,
							width: 40,
							filter: filters.locations.includes('river')
								? 'grayscale(0)'
								: 'grayscale(1)',
						}}
						variant="contained"
						color="primary"
						onClick={() => toggleFilter('locations', 'river')}
					>
						<Typography fontSize={24}>R</Typography>
					</IconButton>
				</Tooltip>
				<Tooltip
					disableHoverListener={!tooltipsEnabled}
				...
				>
					<IconButton
						sx={{
							height: 40,
							width: 40,
							filter: filters.locations.includes('pond')
								? 'grayscale(0)'
								: 'grayscale(1)',
						}}
						variant="contained"
						color="primary"
						onClick={() => toggleFilter('locations', 'pond')}
					>
						<Typography fontSize={24}>P</Typography>
					</IconButton>
				</Tooltip>
				<Tooltip
					disableHoverListener={!tooltipsEnabled}
				...
				>
					<IconButton
						sx={{
							height: 40,
							width: 40,
							filter: filters.locations.includes('ocean')
								? 'grayscale(0)'
								: 'grayscale(1)',
						}}
						variant="contained"
						color="primary"
						onClick={() => toggleFilter('locations', 'ocean')}
					>
